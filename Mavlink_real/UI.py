...
from MAVlink_Linh import MyMAVlink

class DroneControlApp:
    def __init__(self) -> None:
        self.MyCopter = MyMAVlink(connection_string= "tcp:127.0.0.1:5762", baudrate= 57600)
        self.window = tk.Tk()
    ...
    def create_search_frame(self):
        ...
        self.button_cont = tk.Button(master=self.frame_search, text='Continue',width=button_width,height=button_heigth,command= lambda: self.MyCopter.mission_interaction(1))
        self.button_stop = tk.Button(master=self.frame_search, text='Stop',width=button_width,height=button_heigth,command= lambda: self.MyCopter.mission_interaction(0))
    ...
    def create_transit_frame(self):
        ...
        self.button_arm = tk.Button(master=self.frame_transit, text='Arm & Takeoff',width=button_width,height=button_heigth,command=lambda:(self.MyCopter.arm_and_takeoff(float(self.entry_arm.get()))))
